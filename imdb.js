...
const torrentLink = "https://yts.mx/browse-movies/" + imdbId;

const button = torrentButton(torrentLink);
...
const p = document.querySelector('[data-testid="hero-subnav-bar-right-block"]')
...
function torrentButton(torrentLink) {
